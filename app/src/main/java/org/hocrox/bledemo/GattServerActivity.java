...
public class GattServerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!bluetoothAdapter.isEnabled()) {
            ...
            startAdvertising();
            startServer();
            notifyRegisteredDevices("sahil Goyal");
        ...
        mSendMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                timeCharacteristic.setValue("sahill");
                mBluetoothGattServer.notifyCharacteristicChanged(bluetoothDevice, timeCharacteristic, false);
    ...
    private void notifyRegisteredDevices(String value) {
        ...
        byte[] exactTime = new byte[0];
        try {
            exactTime = value.getBytes("UTF-8");
